...
var btn_easy, btn_medium, btn_hard, btn_expert, btn_start;                          // Button zur Auswahl
var coin_cursor;                        
    ...
    */
    ...
    create() {    
        ...
        */
        ...
        btn_start = this.add.text(0, 0, "START", {fontFamily: 'AhkioW05-Light', fontSize: '50px', fill: "#000000", textDecoration: "underline"});
        btn_start.y = bubble.y;
        btn_start.x = bubble.x + 130;
        btn_start.setInteractive();
        btn_start.setVisible(false);
        btn_start.on('pointerover', () => {
            btn_start.setShadow(3, 3, 'rgba(0,0,0,0.78)', 5);
        })
        btn_start.on('pointerout', () => {
            btn_start.setShadow(0, 0, 'rgba(0,0,0,0.78)', 0);
        })
        ...
        */
        ...
        btn_easy.on('pointerup', () => {
            ...
            btn_start.on('pointerup', () => {this.scene.start('Game_Easy')});
        })
        ...
        btn_medium.on('pointerup', () => {
            ...
            red_cross.setVisible(true);
            btn_start.setVisible(true);
            btn_start.on('pointerup', () => {this.scene.start('Game_Medium')});
        })
        ...
        btn_hard.on('pointerup', () => {
            ...
            red_cross.setVisible(true);
            btn_start.setVisible(true);
            btn_start.on('pointerup', () => {this.scene.start('Game_Hard')});
        })
